...
/**
 * No-op stub for android.util.Log used by the desktop renderer worker.
 * Composables that call Log.* at preview time would otherwise throw NoClassDefFoundError.
 */
